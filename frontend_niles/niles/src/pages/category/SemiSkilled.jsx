...
const SemiSkilled = () => {
    ...
    console.log(semiJOb);
    console.log(semiskill);

    const word = semiskill.name || "";
    ...
    return (
        <>
            <section className='py-20 relative'>
                <img className='absolute h-full w-full top-0 left-0 object-cover' src={semiskill.slider_image} alt="background" />
            ...
            <section className="py-12">
                <div className="container flex flex-col items-center">
                    <h2 className='lg:text-4xl sm:text-3xl text-2xl font-bold pb-2 mb-6 relative pseudo-border' data-aos="fade-up" data-aos-duration="1000" data-aos-once='true'>{semiskill.title}</h2>
                    <div className='text-gray-700' data-aos="fade-right" data-aos-duration="1000" data-aos-once='true' data-aos-delay='200'>
                        <p className='mb-2' dangerouslySetInnerHTML={{__html : semiskill.short_desc}}></p>
                    </div>
